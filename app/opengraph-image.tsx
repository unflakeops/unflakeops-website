...
export default function OpenGraphImage() {
  return new ImageResponse(
    <div style={{ width: 1200, height: 630, background: "#fbf8f2", color: "#171526", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "70px 78px", fontFamily: "sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 18 }}><img src="https://www.unflakeops.com/unflakeops-symbol.png" alt="" width="74" height="74" /><span style={{ fontSize: 38, fontWeight: 800, letterSpacing: "-0.04em" }}>UnflakeOps</span></div>
