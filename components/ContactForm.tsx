...
export default function ContactForm() {
  ...
  return (
    <form className="charity-contact" onSubmit={handleSubmit} noValidate aria-label="Workflow conversation form">
      ...
      <p className="cf-privacy">We use these details to respond to your enquiry. See our <Link href="/privacy">Privacy Policy</Link>.</p>
      {status === "error" && <p className="cf-feedback cf-feedback-error" role="alert">{errorMsg}</p>}
      {status === "success" && <p className="cf-feedback cf-feedback-success" role="status" tabIndex={-1}>Thank you. We&apos;ve received your enquiry and will reply within one business day.</p>}
